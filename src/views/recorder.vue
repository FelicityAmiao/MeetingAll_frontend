  ...
  <div class='main'>
    ...
    <div class='mainBox'>
      <div>
        ...
        Sample Rate: <input type='text' v-model='sampleRate' style='width:60px' /> hz
      </div>

      <div>
        <button class='mainBtn ctrlBtn' @click='recOpen'>
          Get Record Permission
        </button>
        <button class='mainBtn ctrlBtn' @click='recStart'>Start Record</button>
        <button class='mainBtn ctrlBtn' @click='recStop'>
          Stop record and release resource
        </button>
      </div>
    </div>
    ...
    >
      <div style='display:flex;height:100%;align-items:center;'>
        ...
        <div
          style='width:240px;background:#fff;padding:15px 20px;border-radius: 10px;'
        >
